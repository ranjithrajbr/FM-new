            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-7 text-center margin-100px-bottom sm-margin-10px-bottom">
                    <div class="position-relative overflow-hidden w-100">
                        ...
                        <h3 class="margin-10px-top semibold-font text-extra-dark-gray">Pre-incubator Program</h3>
                    </div>
                </div>
            </div>
            <!--project-info-->
            <div class="row padding-50px-lr">
                ...
                <div class="col-lg-4 text-md-left text-center offset-lg-2 wow ">
                    <ul class="list-style-8 margin-twelve-left project-font">
                        <li class="text-uppercase text-small"><span class="d-block text-medium text-extra-dark-gray">venue</span>Multiple Venues</li>
                    </ul>
                </div>
            </div>
            <!--end-project-info-->
