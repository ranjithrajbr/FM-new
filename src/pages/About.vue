<template>
  <Layout>
    <section class="bg-position-about-mob padding-100px-bottom bg-tab-about md-padding-0px-bottom background-size-cover" :style="{backgroundImage: 'url('+ require('../assets/images/about/a-banner.svg')+')',
                ...
                <div class="col-12 col-md-6 col-lg-6 text-md-left text-center">
                    <div class="padding-ten-all sm-no-padding">
                        <p class="text-extra-dark-gray alt-font">
                            ...
                            in Global Entrepreneurship Index (GEI) with 28.4 points
                        </p>
                        <h2 class="fm-orange semibold-font">Why?</h2>
                        <p class="text-extra-dark-gray light-font">
                            Foundation of the startup culture lacks innovation and
                            collective culturalism.
                        </p>
                        <div class="center-mob" style="width: 20%; border: 1px solid #ed7015;"></div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 sm-padding-30px-top d-md-flex flex-column justify-content-center">
                    <div class="padding-ten-all md-no-padding">
                        <img src="../assets/images/about/map.svg" />
                    </div>
                </div>
            </div>
    ...
    <section class="wow bg-light-gray position-relative">
        <div class="container">
            ...
            <img class="blob-about-fix position-absolute blob-right" src="../assets/images/about/blob-board.svg" />
        </div>
    </section>
    <section class="wow">
            ...
            <div class="row justify-content-around">
                ...
                <div class="col-lg-4 padding-10px-all col-md-4 d-flex text-md-left flex-column justify-content-center text-center">
                    ...
                    <p class="light-font text-extra-dark-gray">
                        ...
                        individuals, organisations, and communities to innovate and find
                        solutions to today’s problems for a promising future.
                    </p>
                    <div class="center-mob" style="width: 20%; border: 1px solid #ed7015;"></div>
                </div>
            </div>
    ...
    <section class="wow no-padding-top padding-20px-bottom extra-color">
        <div class="container">
